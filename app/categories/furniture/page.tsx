...
const products = [
  {
    ...
    condition: "Very Good",
    seller: "RetroHome",
    image: "/mid-century-modern-coffee-table.jpg",
    rating: 4.8,
  ...
  },
  {
    ...
    condition: "Very Good",
    seller: "BookLover",
    image: "/wooden-bookshelf-unit.jpg",
    rating: 4.7,
    location: "Boston, MA",
  },
]
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-bold text-foreground mb-2">Furniture</h1>
            <p className="text-muted-foreground">Quality pre-owned furniture for sustainable living</p>
          </div>
        </div>
