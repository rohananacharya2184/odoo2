...
const products = [
  ...
  },
  {
    ...
    originalPrice: 699,
    condition: "Good",
    seller: "OutdoorLiving",
    image: "/patio-furniture-set.jpg",
    rating: 4.5,
    location: "Phoenix, AZ",
  },
  {
  ...
  {
    id: 24,
    name: "Indoor Plants Bundle",
    price: 35,
    originalPrice: 89,
    condition: "Excellent",
    seller: "PlantParent",
    image: "/indoor-plants-bundle.jpg",
    rating: 4.9,
    location: "Seattle, WA",
  },
]
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-bold text-foreground mb-2">Home & Garden</h1>
            <p className="text-muted-foreground">Transform your space with sustainable home goods</p>
          </div>
        </div>
