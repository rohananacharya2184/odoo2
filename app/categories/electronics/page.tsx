...
const products = [
  {
    ...
    condition: "Excellent",
    seller: "TechSeller",
    image: "/iphone-13-pro-smartphone.jpg",
    rating: 4.8,
  ...
  },
  {
    ...
    condition: "Very Good",
    seller: "AppleFan",
    image: "/macbook-air-m1-laptop.jpg",
    rating: 4.9,
    location: "Austin, TX",
  },
  {
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-bold text-foreground mb-2">Electronics</h1>
            <p className="text-muted-foreground">Discover sustainable tech deals and pre-owned electronics</p>
          </div>
        </div>
