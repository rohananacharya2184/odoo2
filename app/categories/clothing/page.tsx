...
const products = [
  ...
  },
  {
    ...
    condition: "Good",
    seller: "SportyStyle",
    image: "/running-shoes-sneakers.jpg",
    rating: 4.5,
    location: "Chicago, IL",
  },
  {
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-4xl font-bold text-foreground mb-2">Clothing & Fashion</h1>
            <p className="text-muted-foreground">Sustainable fashion finds and pre-loved clothing</p>
          </div>
        </div>
